...
def run_kitti():
    ...
    # run_experiment_sequences("/root/data/vdo_slam/kitti/kitti/0020/", "test", kitti_dataset,"--v=0", "--shrink_row=25", "--shrink_col=50",  "--use_backend=false", "--use_object_motion_filtering=true")
