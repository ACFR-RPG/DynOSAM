...
#include "dynosam_nn/trackers/byte_tracker/STrack.hpp"
#include "dynosam_nn/trackers/byte_tracker/lapjv.hpp"
...
class ByteTracker {
 public:
  ...
  std::vector<STrackPtr> update(
      const std::vector<dyno::ObjectDetection> &objects);
